...
class SLatFlowModel(nn.Module):
    ...
    def forward(self, x: sp.SparseTensor, t: torch.Tensor, cond: torch.Tensor, cond01, alpha=None, row_ind=None, col_ind=None,group_size=None, counter=None) -> sp.SparseTensor:
        ...
        for block in self.blocks:
            #  
            #pdb.set_trace()
            h = block(h, t_emb, cond, self.kv_dict_img0, self.kv_dict_img1,  alpha, self.step_id0, row_ind, col_ind,group_size, counter)
